...
Please **do not** use the issue tracker for personal support requests nor feature requests. Support requests and Development issues can be discussed on the [Github Discussions](https://github.com/FabriDamazio/componex/discussions) page.

We do our best to keep the issue tracker tidy and organized, making it useful
for everyone. For example, we classify open issues per perceived difficulty,
making it easier for developers to [contribute to Componex](#pull-requests).
...
your Operating System, as well as your Erlang, Elixir, Phoenix and Componex versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/componex

   # Navigate to the newly cloned directory
   cd componex

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/FabriDamazio/componex
   ```
